...
Ext.onReady(function(){
    ...
    var departmentEmployeeCreateForm = new Ext.form.FormPanel({
        ...
        items: [
            ...
            {fieldLabel: '部门',id: 'departmentCombo', hiddenName: 'department',xtype: 'combo',triggerAction: 'all', forceSelection: true,valueField: 'id', displayField: 'department',emptyText:'请选择部门', mode: 'remote', store: new Ext.data.JsonStore({url: '/foundation/department/associationListJSON', fields:['id', 'department'],  root: 'root', totalProperty: 'total'})},
            {fieldLabel: '员工',id: 'employeeCombo', hiddenName: 'employee',xtype: 'combo',triggerAction: 'all', forceSelection: true,valueField: 'id', displayField: 'employee',emptyText:'请选择员工', mode: 'remote', store: new Ext.data.JsonStore({url: '/foundation/employee/associationListJSON', fields:['id', 'employee'],  root: 'root', totalProperty: 'total'})}        ]
    });
    ...
    var departmentEmployeeUpdateForm = new Ext.form.FormPanel({
        ...
        items: [
            {fieldLabel:'id',name: 'id',xtype: 'numberfield',hidden:true,hideLabel:true},
            {fieldLabel: '部门',hiddenName: 'department',xtype: 'combo',triggerAction: 'all', forceSelection: true,valueField: 'id', displayField: 'department',emptyText:'请选择部门', mode: 'remote', store: new Ext.data.JsonStore({url: '/foundation/department/associationListJSON', fields:['id', 'department'],  root: 'root', totalProperty: 'total'})},
            {fieldLabel: '员工',hiddenName: 'employee',xtype: 'combo',triggerAction: 'all', forceSelection: true,valueField: 'id', displayField: 'employee',emptyText:'请选择员工', mode: 'remote', store: new Ext.data.JsonStore({url: '/foundation/employee/associationListJSON', fields:['id', 'employee'],  root: 'root', totalProperty: 'total'})}
        ]
    });
    ...
    var departmentEmployeeDetailForm = new Ext.form.FormPanel({
        ...
        items: [
            {fieldLabel:'id',name: 'id',xtype: 'numberfield',hidden:true,hideLabel:true},
            {fieldLabel: '部门',hiddenName: 'department',xtype: 'combo',triggerAction: 'all', forceSelection: true,valueField: 'id', displayField: 'department',emptyText:'请选择部门', mode: 'remote', store: new Ext.data.JsonStore({url: '/foundation/department/associationListJSON', fields:['id', 'department'],  root: 'root', totalProperty: 'total'}), readOnly:true},
            {fieldLabel: '员工',hiddenName: 'employee',xtype: 'combo',triggerAction: 'all', forceSelection: true,valueField: 'id', displayField: 'employee',emptyText:'请选择员工', mode: 'remote', store: new Ext.data.JsonStore({url: '/foundation/employee/associationListJSON', fields:['id', 'employee'],  root: 'root', totalProperty: 'total'}), readOnly:true}
        ]
    });
    ...
    tb.render('departmentEmployeeToolbar');
    ...
    var grid = new Ext.grid.GridPanel({
        renderTo: 'departmentEmployeeGrid',
        store: store,
    ...
    <body>
        <div id="departmentEmployeeToolbar"></div>
        <div id="departmentEmployeeGrid"></div>
