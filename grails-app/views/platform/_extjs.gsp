...
<link rel="stylesheet" type="text/css" href="/foundation/ext/foundation.css" />
...
<script type="text/javascript" src="/foundation/ext/foundation.js" ></script>
<script>
	Ext.BLANK_IMAGE_URL = '/foundation/ext/resources/images/default/s.gif';
</script>